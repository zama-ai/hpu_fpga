...
proc create_hier_cell_shell_wrapper { parentCell nameHier } {
  ...
  set clk_eth_freerun_0_pin [ create_bd_pin -dir O -type clk clk_eth_freerun_0 ]
  set clk_eth_qsfp_0_pin [ create_bd_pin -dir O -type clk clk_eth_qsfp_0 ]
  ...
  set resetn_eth_qsfp_ic_0_pin [ create_bd_pin -dir O -from 0 -to 0 -type rst resetn_eth_qsfp_ic_0 ]
  set resetn_eth_freerun_ic_0_pin [ create_bd_pin -dir O -from 0 -to 0 -type rst resetn_eth_freerun_ic_0 ]
...
\
  ...
  connect_bd_net -net clock_reset_eth_freerun   [get_bd_pins clock_reset/clk_eth_freerun] [get_bd_pins clk_eth_freerun_0]
  connect_bd_net -net clock_reset_eth_qsfp      [get_bd_pins clock_reset/clk_eth_qsfp] [get_bd_pins clk_eth_qsfp_0]
  ...
  connect_bd_net -net clock_reset_resetn_qsfp_ic [get_bd_pins clock_reset/resetn_eth_qsfp_ic] [get_bd_pins resetn_eth_qsfp_ic_0]
  connect_bd_net -net clock_reset_resetn_eth_qsfp_ic [get_bd_pins clock_reset/resetn_eth_freerun_ic] [get_bd_pins resetn_eth_freerun_ic_0]
