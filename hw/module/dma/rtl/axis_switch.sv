...
module axis_switch #(
  ...
  input [$clog2(LINE_NB)-1:0] line_sel
);
  ...
  // TX link
  logic [LINE_NB-1:0][AXIS_TDATA_W-1:0] temp_tx_tdata;
  logic [LINE_NB-1:0][AXIS_TKEEP_W-1:0] temp_tx_tkeep_user;
  logic [LINE_NB-1:0]                   temp_tx_tlast;
  logic [LINE_NB-1:0]                   temp_tx_tvalid;
