...
###################################################################################################
##**** TODO ****##
# Uncomment this section, and complete to generate stimuli if necessary
#if [ $GEN_STIMULI -eq 1 ] ; then
#    # Stimuli must be generated in $INPUT_DIR
#    echo "INFO> Generating stimuli"
#else
#    echo "INFO> Use existing stimuli"
#fi
##**************##
...
###################################################################################################
##**** TODO ****##
# complete eda_args argument here.
##**************##
