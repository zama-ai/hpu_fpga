...
package hpu_regif_core_mhdma_2in3_pkg;
  ...
  typedef struct packed {
    ...
    logic [(6-1):0] flag;
    logic [(8-1):0] rsvd;
   } mhdma_request_notify_req_id_t;
  localparam int MHDMA_REQUEST_NOTIFY_REQ_ID_OFS = 'h50108;
  typedef struct packed {
    logic [(16-1):0] dst;
    logic [(16-1):0] src;
   } mhdma_request_notify_req_addr_t;
  localparam int MHDMA_REQUEST_NOTIFY_REQ_ADDR_OFS = 'h5010c;
  typedef struct packed {
    logic [(8-1):0] iop_id;
    logic [(4-1):0] req_id;
    logic [(4-1):0] node_id;
    ...
    logic [(6-1):0] flag;
    logic [(8-1):0] rsvd;
   } mhdma_request_read_request_req_id_t;
  localparam int MHDMA_REQUEST_READ_REQUEST_REQ_ID_OFS = 'h50110;
  typedef struct packed {
    logic [(16-1):0] dst;
    logic [(16-1):0] src;
   } mhdma_request_read_request_t;
  localparam int MHDMA_REQUEST_READ_REQUEST_OFS = 'h50114;
  localparam int MHDMA_REQUEST_STAT_NOTIFY_OFS = 'h50118;
