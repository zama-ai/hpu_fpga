...
TEMPLATE_NAME = "hpu_twdfile_definition_pkg.sv.j2"
...
#=====================================================
    ...
    parser.add_argument('-ifnl', dest='ifnl',  type=str, help="INTT Final twiddles", required=True)
    parser.add_argument('-phru', dest='phru',  type=str, help="PHI Root of unity", required=True)
    parser.add_argument('-phi',  dest='phi',   type=str, help="PHI fro GF64", required=True)
