...
# ----------------------------------------------------------------------------------------------
#  Script used to create a ntt_core_gf64_common_definition_pkg.sv file.
# ==============================================================================================
...
TEMPLATE_NAME = "ntt_core_common_cut_definition_pkg.sv.j2"
...
#=====================================================
    ...
    parser.add_argument('-J',   dest='col_l',   type=int, help="Number of stages for each radix column.", default=[], action='append')
...
#=====================================================
    ...
    # check parameters
    if (len(args.col_l) == 0):
        sys.exit("ERROR> No radix column description given!.")

    col_l = args.col_l
    col_l_s = ""
    for i in args.col_l:
      col_l_s = f"32'd{i}," + col_l_s
    col_l_s = "{"+col_l_s[:-1]+"}"

    config = {"col_nb" : len(col_l),
              "col_l"  : col_l_s}
