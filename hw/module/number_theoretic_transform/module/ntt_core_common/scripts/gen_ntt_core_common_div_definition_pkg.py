...
TEMPLATE_NAME = "ntt_core_common_div_definition_pkg.sv.j2"
...
#=====================================================
    ...
    parser.add_argument('-e', dest='bwd_psi_div', type=int, help="PSI/BWD_PSI_DIV: Number of butterflies in INTT.", default=1)
...
#=====================================================
    ...
    config = {"bwd_psi_div": args.bwd_psi_div}
