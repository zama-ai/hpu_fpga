...
TEMPLATE_NAME = "bsk_ntw_common_definition_pkg.sv.j2"
...
#=====================================================
    ...
    parser.add_argument('-a', dest='bsk_dist_coef_nb', type=int, help="BSK_DIST_COEF_NB: Number of coefficients in the distribution interface", default=48)
...
#=====================================================
    ...
    config = {"bsk_dist_coef_nb"       : args.bsk_dist_coef_nb}
