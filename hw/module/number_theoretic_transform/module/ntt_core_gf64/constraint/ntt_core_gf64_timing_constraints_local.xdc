...
#set_property PARENT pblock_dynamic_SLR0 [get_pblocks user_pblock_SLR0_left]
#set_property PARENT pblock_dynamic_SLR0 [get_pblocks user_pblock_SLR0_right]
...
#set_property PARENT pblock_dynamic_SLR1 [get_pblocks user_pblock_SLR1_left]
#set_property PARENT pblock_dynamic_SLR1 [get_pblocks user_pblock_SLR1_right]
...
#set_property PARENT pblock_dynamic_SLR2 [get_pblocks user_pblock_SLR2_left]
#set_property PARENT pblock_dynamic_SLR2 [get_pblocks user_pblock_SLR2_right]

#add_cells_to_pblock user_pblock_SLR1_left [get_cells -hierarchical -regexp [list .*ntt_core_gf64_head]] -clear_locs
#add_cells_to_pblock user_pblock_SLR1_right [get_cells -hierarchical -regexp [list .*ntt_core_gf64_tail]] -clear_locs
add_cells_to_pblock user_pblock_SLR1_left [get_cells -hierarchical -regexp [list .*ntt_core_gf64_head]] -clear_locs
add_cells_to_pblock user_pblock_SLR1_left [get_cells -hierarchical -regexp [list .*ntt_core_gf64_tail]] -clear_locs
