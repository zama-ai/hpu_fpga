...
TEMPLATE_NAME = "pea_alu_definition_pkg.sv.j2"
...
#=====================================================
    ...
    parser.add_argument('-pea_alu_nb',   dest='pea_alu_nb',  type=int, help="PEA_ALU_NB", default=2)
...
#=====================================================
    ...
    config = {"pea_alu_nb" : args.pea_alu_nb}
