...
TEMPLATE_NAME = "ksk_mgr_common_slot_definition_pkg.sv.j2"
...
#=====================================================
    ...
    parser.add_argument('-ksk_slot', dest='ksk_slot',  type=int, help="KSK_SLOT_NB: Number of slots in ksk_manager.", default=8)
