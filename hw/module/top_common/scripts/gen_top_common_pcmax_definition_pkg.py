...
# ----------------------------------------------------------------------------------------------
#  Script used to create a top_common_pcmax_definition_pkg.sv file.
# ==============================================================================================
...
TEMPLATE_NAME = "top_common_pcmax_definition_pkg.sv.j2"
...
#=====================================================
    ...
    parser.add_argument('-pem_pc',dest='pem_pc',    type=int, help="Maximum number of PC for PEM", default=1)
    parser.add_argument('-glwe_pc',dest='glwe_pc',  type=int, help="Maximum number of PC for GLWE", default=1)
    parser.add_argument('-bsk_pc',dest='bsk_pc',    type=int, help="Maximum number of PC for BSK", default=1)
    parser.add_argument('-ksk_pc',dest='ksk_pc',    type=int, help="Maximum number of PC for KSK", default=1)
