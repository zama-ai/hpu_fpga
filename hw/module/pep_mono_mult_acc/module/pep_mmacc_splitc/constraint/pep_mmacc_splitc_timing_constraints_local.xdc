...
add_cells_to_pblock user_pblock_SLR0 [get_cells -hierarchical -regexp .*pep_mmacc_splitc_main] -clear_locs
add_cells_to_pblock user_pblock_SLR1 [get_cells -hierarchical -regexp .*pep_mmacc_splitc_subsidiary] -clear_locs
...
add_cells_to_pblock user_pblock_SLR0_left [get_cells -hierarchical -regexp .*pep_mmacc_splitc_main_acc/pep_mmacc_splitc_acc_core/qpsi0_.*] -clear_locs
add_cells_to_pblock user_pblock_SLR0_right [get_cells -hierarchical -regexp .*pep_mmacc_splitc_main_acc/pep_mmacc_splitc_acc_core/qpsi1_.*] -clear_locs
add_cells_to_pblock user_pblock_SLR1_left [get_cells -hierarchical -regexp .*pep_mmacc_splitc_subs_acc/pep_mmacc_splitc_acc_core/qpsi0_.*] -clear_locs
add_cells_to_pblock user_pblock_SLR1_right [get_cells -hierarchical -regexp .*pep_mmacc_splitc_subs_acc/pep_mmacc_splitc_acc_core/qpsi1_.*] -clear_locs
...
#add_cells_to_pblock user_pblock_SLR0_left [get_cells -hierarchical -regexp .*pep_mmacc_splitc_main/qpsi0__pep_mmacc_glwe_ram/.*pep_mmacc_gram_core/glwe_ram/ram_2RW/ram_2RW_core/a_reg.*] -clear_locs
#add_cells_to_pblock user_pblock_SLR0_right [get_cells -hierarchical -regexp .*pep_mmacc_splitc_main/qpsi1__pep_mmacc_glwe_ram/.*pep_mmacc_gram_core/glwe_ram/ram_2RW/ram_2RW_core/a_reg.*] -clear_locs
#add_cells_to_pblock user_pblock_SLR1_left [get_cells -hierarchical -regexp .*pep_mmacc_splitc_subsidiary/qpsi0__pep_mmacc_glwe_ram/.*pep_mmacc_gram_core/glwe_ram/ram_2RW/ram_2RW_core/a_reg.*] -clear_locs
#add_cells_to_pblock user_pblock_SLR1_right [get_cells -hierarchical -regexp .*pep_mmacc_splitc_subsidiary/qpsi1__pep_mmacc_glwe_ram/.*pep_mmacc_gram_core/glwe_ram/ram_2RW/ram_2RW_core/a_reg.*] -clear_locs
#
