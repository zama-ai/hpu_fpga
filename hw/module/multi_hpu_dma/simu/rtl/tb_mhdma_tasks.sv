...
function automatic void display_errors(
  ...
  $display(" master.max_retry_rr_error               : %b", errors_struct.mhdma_error.master_error.max_retry_rr_error);
  $display(" master.max_retry_notify_error           : %b", errors_struct.mhdma_error.master_error.max_retry_notify_error);
