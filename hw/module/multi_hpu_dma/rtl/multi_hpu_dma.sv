...
#(
  ...
  // clear the notify interrupt generated by the bridge
  assign clear_interrupt_notify = (s_axil_dma_araddr == REQUEST_NOTIFY_OFS) && s_axil_dma_arready;
  assign clear_interrupt_rr = (s_axil_dma_araddr == REQUEST_READ_REQUEST_OFS) && s_axil_dma_arready;
